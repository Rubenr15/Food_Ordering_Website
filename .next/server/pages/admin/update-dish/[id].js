...
/* harmony import */ var bson__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(61);
/* harmony import */ var bson__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(bson__WEBPACK_IMPORTED_MODULE_6__);
...
function UpdateDish(props) {
  var _props$dish, _props$dish2, _props$dish3, _props$dish4, _props$dish5;

  const {
    0: title,
    1: setTitle
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props === null || props === void 0 ? void 0 : (_props$dish = props.dish) === null || _props$dish === void 0 ? void 0 : _props$dish.title);
  const {
    0: description,
    1: setDescription
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props === null || props === void 0 ? void 0 : (_props$dish2 = props.dish) === null || _props$dish2 === void 0 ? void 0 : _props$dish2.description);
  const {
    0: price,
    1: setPrice
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props === null || props === void 0 ? void 0 : (_props$dish3 = props.dish) === null || _props$dish3 === void 0 ? void 0 : _props$dish3.price);
  const {
    0: image,
    1: setImage
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props === null || props === void 0 ? void 0 : (_props$dish4 = props.dish) === null || _props$dish4 === void 0 ? void 0 : _props$dish4.image);
  const {
    0: category,
    1: setCategory
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props === null || props === void 0 ? void 0 : (_props$dish5 = props.dish) === null || _props$dish5 === void 0 ? void 0 : _props$dish5.category);
  ...
  const formHandler = e => {
    e.preventDefault();
    setDisabled(true);
    axios__WEBPACK_IMPORTED_MODULE_2___default().post("/api/admin/update-dish", {
      _id: router.query.id,
      title,
      category,
      description,
      ...
      (0,_util_Toast_NormalToast__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z)("Updated successfully");
      setDisabled(false);
    }).catch(err => {
      (0,_util_Toast_NormalToast__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z)("Something went wrong", err);
      console.error(err);
      setDisabled(false);
    });
  };
...
/* harmony default export */ __webpack_exports__["default"] = (UpdateDish);
...
const getStaticProps = async context => {
  ...
  try {
    const client = await _util_mongodb__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z;
    const db = await client.db("sample_data");
    dish = await db.collection("dishes").findOne({
      _id: (0,bson__WEBPACK_IMPORTED_MODULE_6__.ObjectId)(context.params.id)
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [7641,1572], function() { return __webpack_exec__(8190); });
