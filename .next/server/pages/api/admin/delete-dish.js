    ...
    if (req.method === "POST") {
      ...
      if (session) {
        ...
        if (admin == false) {
          ...
          await db.collection("dishes").deleteOne({
            _id: (0,bson__WEBPACK_IMPORTED_MODULE_0__.ObjectId)(req.body._id)
          });
...
var __webpack_exports__ = __webpack_require__.X(0, [7641], function() { return __webpack_exec__(1338); });
